import { Currency, currencyEquals, ETHER, WETH } from '@123swap/swap-sdk'
...
export default function useWrapCallback(
  ...
  return useMemo(() => {
    ...
    if (isBaseCurrency(inputCurrency) && currencyEquals(getNetworkWrappedCurrency(chainId), outputCurrency)) {
      return {
